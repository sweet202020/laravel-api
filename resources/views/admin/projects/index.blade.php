...
@section('content')
    <section class="products py-5">
        <div class="container">
            <a class="btn btn-primary btn-lg text-uppercase" href="{{ route('admin.types.index') }}" role="button">view the
                types of project</a>
                            ...
                            <tr class="table-primary">
                                ...
                                <td class="d-flex flex-column gap-2">
                                    ...
                                    <div class="modal fade" id="deleteproject-{{ $project->slug }}" tabindex="-1"
                                        ...
                                        aria-labelledby="modalTitleId-{{ $project->slug }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                            role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalTitleId-{{ $project->slug }}">
                                                        delete
                                                        project</h5>
